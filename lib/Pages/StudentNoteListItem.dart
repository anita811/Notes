  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child:Column(
          ...
          children: [
            Text('Course. $_course / Semester. $_semester',style: TextStyle(color:Colors.redAccent ,fontSize: 20.0,fontWeight:FontWeight.bold),),
            ...
            Row(
              ...
              children: [
                ...
                FlatButton.icon(onPressed: (){},label:Text('Download'),icon:Icon(Icons.arrow_circle_down),textColor: Colors.redAccent,),
